...
with(na_by_state, 
     plot(coal_production.y ~ coal_production.x, pch=21, bg=hsv(0,.7,.8),
...
#plot
ggplot(by_state, aes(reorder(state, sort(value, decreasing=T)), value)) +
...
employ_map; product_map
```

![](project_us_coal_production_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-8-1.png)![](project_us_coal_production_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-8-2.png)
